...
public class culik2Activity extends AppCompatActivity {
    EditText mTextNama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_culik2);
    ...
    public void onClickOrder(View view){
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, "andriyansyah58@gmail.com");
